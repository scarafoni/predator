...
{	
	public static void main(String[] args) throws IOException 
	{
        	...
        	final int preyTeams = Integer.parseInt(args[1]);
        	final int predTeams = Integer.parseInt(args[2]);
        	final boolean filterSide = Boolean.parseBoolean(args[3]);
        	final boolean filterTeam = Boolean.parseBoolean(args[4]);
        	final int radius = Integer.parseInt(args[5]);
...
class Server implements Runnable
{
	...
	public void run()
	{
		try 
		{
			...
			/* I was told to disable game over conditions */
			/*if(board.isGameOver())
			{
				board.writeAll("Game over, predators win!");
				System.exit(1);
			}
